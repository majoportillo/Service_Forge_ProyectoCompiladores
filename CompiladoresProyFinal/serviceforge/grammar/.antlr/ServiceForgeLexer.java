...
public class ServiceForgeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "API", "RESOURCE", "FIELDS", "ENDPOINT", "RELATIONSHIP", "GET", 
			"POST", "PUT", "DELETE", "PATCH", "INT", "STRING", "EMAIL", "BOOLEAN", 
			"DATETIME", "DECIMAL", "UUID", "REQUIRED", "UNIQUE", "PK", "DEFAULT", 
			"MIN", "MAX", "PAGINATED", "AUTH_TYPE", "HAS_MANY", "HAS_ONE", "BELONGS_TO", 
			"BOOLEAN_LIT", "VERSION_NUMBER", "NUMBER", "PATH", "STRING_LITERAL", 
	...
	public ServiceForgeLexer(CharStream input) {
		super(input);
